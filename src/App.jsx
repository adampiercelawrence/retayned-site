...
function Nav({ page, setPage }) {
  ...
  return (
    <>
      <nav style={{ position: "sticky", top: 0, zIndex: 50, background: scrolled ? "rgba(249, 239, 228, 0.85)" : "#F9EFE4", backdropFilter: scrolled ? "saturate(180%) blur(12px)" : "none", WebkitBackdropFilter: scrolled ? "saturate(180%) blur(12px)" : "none", borderBottom: scrolled ? "1px solid rgba(0,0,0,0.06)" : "1px solid transparent", boxShadow: scrolled ? "0 1px 0 rgba(0,0,0,0.02), 0 8px 24px -12px rgba(0,0,0,0.08)" : "none", transition: "box-shadow 0.25s, border-color 0.25s, background 0.25s" }}>
